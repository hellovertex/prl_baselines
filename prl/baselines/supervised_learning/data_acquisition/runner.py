...
class Runner:
    ...
    def _encode(self, from_parsed_hands):
        ...
        for i, hand in enumerate(from_parsed_hands):
            observations, actions = self.encoder.encode_episode(hand,
                                                                drop_folds=self.drop_folds,
                                                                randomize_fold_cards=self.randomize_fold_cards,
                                                                verbose=False,
    ...
    #     """
    #     :param out_dir: determines data folder paths that are looked up and created, e.g. "data/01_raw/0.25-0.50"
    ...
    #         fpath = str(DATA_DIR) + '/01_raw' + f'/{out_dir}' + '/eda_result_filtered.txt'
