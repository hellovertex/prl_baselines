...
if __name__ == "__main__":
    ...
    for freq in target_update_frequencies:
        train_eval(f"targ_upd_freq={freq}", target_update_freq=freq)
    ...
    for buffer_size in buffer_sizes:
        train_eval(f"buffer_size={buffer_size}",
    ...
    print(f"Job Finished, best parameters were:"
